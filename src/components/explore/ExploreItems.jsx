...
const ExploreItems = () => {
  ...
  async function filterExplore(filter){
    setLoading(true)
  ...
  return (
    <>
      <div>
        ...
        {details.slice(0,items).map(detail => (
          <>
            {loading ? (
              <Skeleton
                width="330px"
              ...
              >
                <div className="nft__item">
                  ...
                  {detail.expiryDate && (<ExpiryDate expiryDate={detail.expiryDate}/>)}
                  ...
                  <div className="nft__item_wrap">
                    ...
                    <Link to={`/item-details/${detail.nftId}`}>
                      <img src={detail.nftImage} className="lazy nft__item_preview" alt="" />
                    </Link>
                  </div>
